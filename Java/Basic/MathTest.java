...
public class MathTest {
	...
	public static void main(String[] args) {
		...
		long y=Math.round(12.456);//12
		System.out.println(y);
		int z=Math.round(12.567f);//13
		System.out.println(z);
		
		double num=12.456;
		//소수점 이하 2자리까지 출력하되 반올해서 출력하세요
		double k=Math.round(num*100)/100.0;    //1245.6 ==>반올림하면 1246
		System.out.println("k: "+k);//12.46
		...
		//random(): 0.0<= r < 1.0 사이의 임의의 실수를 발생시켜 반환함
		/*
